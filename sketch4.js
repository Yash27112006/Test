...
function setup(){
  ...
  button3.position(windowWidth/2+windowWidth/2-150,30);
...
function draw(){
  ...
  //displays the text
  text("Click the button only after you select the image and enter the details.", 8,260);
}
